...
angular.module('starterApp')
    .controller('HexController', function ($scope) {


  var g = document.getElementById("monSvg");

  var size = 40;
  var sr3sur2 = size * 0.866;

  var mapDecalageX = 0;
  var mapDecalageY = 4;

  var centre1 = [-size / 2, sr3sur2];
  var centre2 = [size / 2, sr3sur2];
  var centre3 = [size, 0];
  var centre4 = [size / 2, -sr3sur2];
  var centre5 = [-size / 2, -sr3sur2];
  var centre6 = [-size, 0];

  var rotPt = function(centre, pt, angle) {
    return [
